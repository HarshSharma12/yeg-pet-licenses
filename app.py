...
app.layout = html.Div(
    children=[
        html.H1(children="Cats 🐈 or Dogs 🐕?\n",style={
                "text-align": "center",
                "margin": "5rem"
            }),
        html.H3(children="Are you in a cat majority neighborhood?",style={
                "margin-bottom": "3rem"
            }),
        html.Div(
            children=f"""
        ...
        html.H3(children="Some other stats about pets in your hood",style={
                "margin-top": "3rem",
                "margin-bottom": "3rem"
            }),
        html.Div(
